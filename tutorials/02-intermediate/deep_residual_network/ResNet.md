...
- Vanishing/Exploding gradients : Authors argue that this is **unlikely** to cause the problem of optimization diffuculty where BN ensures healty norms.
...
- By adding identity layers, deep networks should perform at least as well as a smaller network ( solve the degradation problem )
